...
!developmentChains.includes(network.name)
    ? describe.skip
    : describe.only('Dynamic SVG NFT Unit Tests', function () {
          ...
          //   Getting wrong URI addresses. Will check on ropsten testnet
          describe('mintNft', () => {
